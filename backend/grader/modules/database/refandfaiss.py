...
# === Load Reference Q&A and Build FAISS Index ===
index_path_loc = os.path.join("indexes", "dbms_index", "index.faiss")


def load_reference_chunks(reference_path="data/dbms_questions.json") -> List[Document]:
