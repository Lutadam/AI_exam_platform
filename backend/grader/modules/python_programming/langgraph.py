...
from grader.modules.python_programming.rag_pipeline import grade_with_deepseek
...
# === ToolNode logic using grade_with_deepseek ===
def grading_tool(state: GraphState) -> GraphState:
    ...
    return {
        **state,
        ...
        "method": result.get("method", "rag-deepseek")
    }
